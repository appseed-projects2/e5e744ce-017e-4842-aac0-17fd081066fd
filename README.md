...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-29 05:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e5e744ce-017e-4842-aac0-17fd081066fd.git
$ cd e5e744ce-017e-4842-aac0-17fd081066fd
```
